...
return loaded(_that.products);case HomeError() when error != null:
...
return loaded(_that.products);case HomeError():
...
class HomeLoaded implements HomeState {
  const HomeLoaded({required final  List<ProductEntity> products}): _products = products;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeLoaded&&const DeepCollectionEquality().equals(other._products, _products));
}
